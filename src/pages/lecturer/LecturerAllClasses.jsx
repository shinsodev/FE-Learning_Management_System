...
// API
import { lecturerGetAllClasses } from "../../services/ClassServices";

// Components
import Loading from "../../components/Loading/Loading";

const LecturerAllClasses = () => {
  ...
  const fetchClassData = async () => {
    setIsLoading(true);
    try {
      const res = await lecturerGetAllClasses(page);
      if (res.status === 200) {
...
export default LecturerAllClasses;
